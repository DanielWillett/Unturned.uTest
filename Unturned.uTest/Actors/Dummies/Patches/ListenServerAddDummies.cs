...
/// </summary>
internal static class ListenServerAddDummies
{
    private const string PatchName = "Provider.listenServer";
    ...
    internal static void Prefix()
    {
        ...
        dummyManager.ListenOnServer();
        dummyManager.ListenOnDummies();
    }
}