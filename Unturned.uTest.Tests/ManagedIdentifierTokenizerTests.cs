...
public class ManagedMethodIdentifierTests
{
    ...
    public void ManagedTypes()
    {
        ...
        AssertTypeStructureEquals(
            ...
            [
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"Namespace"),
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"𝐂𝐥𝐚𝐬𝐬🦄")
            ]
        );
        ...
        AssertTypeStructureEquals(
            @"Κατηγορία.Δοκιμή",
            [
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"Κατηγορία"),
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"Δοκιμή")
            ]
        );
        ...
        AssertTypeStructureEquals(
            @"سم.اختبار",
            [
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"سم"),
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"اختبار")
            ]
        );
        ...
        AssertTypeStructureEquals(
            @"命名空間.类名",
            [
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"命名空間"),
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"类名")
            ]
        );
        ...
        AssertTypeStructureEquals(
            ...
            [
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"Namespace"),
                new ContentToken(ManagedIdentifierTokenType.TypeSegment, @"Class With 🚀 Unicode 😈 and Spaces")
            ]
        );
    ...
    public void ManagedMethods()
    {
        ...
        AssertMethodStructureEquals(
            @"'𝒲𝒾𝓉𝒽 Unicode ♥'()",
            [
                new ContentToken(ManagedIdentifierTokenType.MethodName, @"𝒲𝒾𝓉𝒽 Unicode ♥"),
                new ContentToken(ManagedIdentifierTokenType.OpenParameters, @"("),
                new ContentToken(ManagedIdentifierTokenType.CloseParameters, @")")
            ]
        );
